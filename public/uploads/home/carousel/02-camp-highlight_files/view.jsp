											...
											if (usi_js.current_time() - usi_js.page_status.back_state_set_time > usi_js.launch.backtrap_timestamp_difference) {
												if (usi_js.launch.back_track == 1) {
													if (typeof(usi_app) !== "undefined") {
														var usi_common_objects = ["product_rec", "product", "product_recs"];
														if (typeof(usi_app.common_objects) !== "undefined") {
															usi_common_objects = usi_common_objects.concat(usi_app.common_objects);
														}
														for (var i = 0; i < usi_common_objects.length; i++) {
															if (typeof (usi_app[usi_common_objects[i]]) !== "undefined") {
																usi_cookies.set("usi_app_" + usi_common_objects[i], JSON.stringify(usi_app[usi_common_objects[i]]), 10000);
															}
														}
													}
